module.exports = {
    ...
    help:
        '&#128221; Доступные команды:\n\n' +
            ...
            '&#10071;номер_напоминания* - номер вашего напоминания в виде числа. Например: 15, 245896, 334_10. Номер показывается при добавлении нового напоминания. Если забыли номер, то можете попросить меня показать Ваши напоминания и найти нужное\n\n' +
